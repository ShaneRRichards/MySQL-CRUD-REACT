...
const db = mysql.createConnection({
    host: "localhost",
    user: "root",
    password: "Jojobaby2020$%",
    database: "test"
})

//if authentican problems, use this command in workbench
// ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'Jojobaby2020$%';
